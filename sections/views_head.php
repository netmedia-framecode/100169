...
<title>
  <?= $name_website ?> <?php if (isset($_SESSION['project_si_inventaris_sekolah']['name_page'])) {
                          if (!empty($_SESSION['project_si_inventaris_sekolah']['name_page'])) {
                            echo " - " . $_SESSION['project_si_inventaris_sekolah']['name_page'];
                          }
                        } ?>
</title>
